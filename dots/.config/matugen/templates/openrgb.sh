...
DARK_NORMAL="{{colors.primary.default.hex_stripped | lighten: -25.0 | saturate: 30.0, "hsl"}}"
LIGHT_NORMAL="{{colors.primary.default.hex_stripped | lighten: 20.0 | saturate: 30.0, "hsl"}}"
DARK_NORMAL_BOOSTED="{{colors.primary.default.hex_stripped | lighten: -25.0 | saturate: 45.0, "hsl"}}"
LIGHT_NORMAL_BOOSTED="{{colors.primary.default.hex_stripped | lighten: 20.0 | saturate: 60.0, "hsl"}}"
